...
<body>
	...
	<input type="hidden" name="id" value="${user.id }">
		<table id="tab" class="table table-bordered table-hover">
			<tr>
				<td>姓名</td>
				<td><input type="text" name="name" placeholder="请填写用户名" value="${user.name }"/></td>
			</tr>
			<tr>
				<td>密码</td>
				<td><input type="text" name="password" placeholder="请填写密码" value="${user.password }"/></td>
			</tr>
			<tr>
				<td>余额</td>
				<td><input type="text" name="money" placeholder="请填写余额" value="${user.money}"/></td>
			</tr>
		</table>
